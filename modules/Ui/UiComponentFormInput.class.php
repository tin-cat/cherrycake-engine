...
class UiComponentFormInput extends UiComponent {
	...
	static function build($setup = false) {
		$UiComponentFormInput = new UiComponentFormInput($setup);
		return $UiComponentFormInput;
	}
	 ...
	 * * size: The size of the input box in characters
	 * * maxLength: The maximum length in characters this input will hold. Defaults to 255
	 ...
	 * * isSubmitOnEnter: Whether to submit the form if enter is pushed while focused on this input
	 *
