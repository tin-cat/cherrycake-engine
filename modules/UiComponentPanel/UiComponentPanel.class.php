 ...
 * @category Classes
 */
class UiComponentPanel extends \Cherrycake\UiComponent {
    /**
	...
	function buildHtml($setup = false) {
        ...
        $r =
            "<div".
                " id=\"UiComponentPanel\"".
				" class=\"".
                    ($this->getConfig("theme") ? $this->getConfig("theme") : null).
                    ($this->getConfig("style") ? " ".$this->getConfig("style") : null).
                    " noAnimations".
				"\"".
            ">";
        ...
        $r .=
            ...
            ">".
                ...
                ($this->getConfig("logo")["linkRequest"] ?? false ? "<a href=\"".$e->Actions->getAction($this->getConfig("logo")["linkRequest"] ?? false)->request->buildUrl()."\"" : "<div").
                    " class=\"logo wide\"".
                    " style=\"".
                        "background-image: url('".$this->getConfig("logo")["fullImageUrl"]."');".
                    "\"".
                ">".
                ($this->getConfig("logo")["linkRequest"] ?? false ? "</a>" : "</div>").

                ($this->getConfig("logo")["linkRequest"] ?? false ? "<a href=\"".$e->Actions->getAction($this->getConfig("logo")["linkRequest"] ?? false)->request->buildUrl()."\"" : "<div").
                    " class=\"logo small\"".
                    " style=\"".
                        "background-image: url('".$this->getConfig("logo")["smallImageUrl"]."');".
                    "\"".
                ">".
                ($this->getConfig("logo")["linkRequest"] ?? false ? "</a>" : "</div>").
        ...
        $e->HtmlDocument->addInlineJavascript("$('#UiComponentPanel').UiComponentPanel(".json_encode([
            "isMainOpen" => $this->getConfig("isMainOpen"),
