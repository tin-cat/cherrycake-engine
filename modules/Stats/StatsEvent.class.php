...
class StatsEvent extends Item {
	...
	protected $fields = [
		...
		"resolution" => ["type" => \Cherrycake\Modules\DATABASE_FIELD_TYPE_INTEGER],
		"timestamp" => ["type" => \Cherrycake\Modules\DATABASE_FIELD_TYPE_DATETIME],
		"secondary_id" => ["type" => \Cherrycake\Modules\DATABASE_FIELD_TYPE_INTEGER],
		"tertiary_id" => ["type" => \Cherrycake\Modules\DATABASE_FIELD_TYPE_INTEGER],
		"count" => ["type" => \Cherrycake\Modules\DATABASE_FIELD_TYPE_INTEGER]
	];

	/**
	 * The time resolution on which to store this events on the database. One of the available \Cherrycake\Modules\STATS_EVENT_TIME_RESOLUTION_*
	 * @var timeResolution
	 */
	...
	function getTimestampForTimeResolution($timestamp = false) {
		...
		switch ($this->timeResolution) {
			case \Cherrycake\Modules\STATS_EVENT_TIME_RESOLUTION_MINUTE:
				$paramsSetup = [true, true, false, true, true, true];
				break;
			case \Cherrycake\Modules\STATS_EVENT_TIME_RESOLUTION_HOUR:
				$paramsSetup = [true, false, false, true, true, true];
				break;
			case \Cherrycake\Modules\STATS_EVENT_TIME_RESOLUTION_DAY:
				$paramsSetup = [false, false, false, true, true, true];
				break;
			case \Cherrycake\Modules\STATS_EVENT_TIME_RESOLUTION_MONTH:
				$paramsSetup = [false, false, false, true, false, true];
				break;
			case \Cherrycake\Modules\STATS_EVENT_TIME_RESOLUTION_YEAR:
