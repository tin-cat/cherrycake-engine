...
abstract class LoginUser extends \Cherrycake\Item {
	 ...
	 * @return bool True if the user could be loaded ok, or false if the load failed, or the user does not exists.
	 */
	public function loadFromUserNameField(string $userName): bool {
	 ...
	 */
	public function afterLoginInit(): bool { return true; }
}
