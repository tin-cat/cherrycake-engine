...
class RequestPathComponent {
	...
	function isMatchesString(string $string): bool {
		switch ($this->type) {
			case \Cherrycake\Modules\Actions\Request::PATH_COMPONENT_TYPE_FIXED:
				return (strcasecmp($string, $this->string) == 0 ? true : false);
				break;

			case \Cherrycake\Modules\Actions\Request::PATH_COMPONENT_TYPE_VARIABLE_STRING:
				return true;
				break;

			case \Cherrycake\Modules\Actions\Request::PATH_COMPONENT_TYPE_VARIABLE_NUMERIC:
	...
	/**
	 * @return string Returns the value passed for this path component, if its type is either \Cherrycake\Modules\Actions\Request::PATH_COMPONENT_TYPE_VARIABLE_STRING or \Cherrycake\Modules\Actions\Request::PATH_COMPONENT_TYPE_VARIABLE_NUMERIC
	 */
	...
	/**
	 * Sets the value for this path component. Intented to apply only for \Cherrycake\Modules\Actions\Request::PATH_COMPONENT_TYPE_VARIABLE_STRING and \Cherrycake\Modules\Actions\Request::PATH_COMPONENT_TYPE_VARIABLE_NUMERIC types
	...
	function getStatus(): array {
		$r["brief"] = ($this->type == \Cherrycake\Modules\Actions\Request::PATH_COMPONENT_TYPE_FIXED ? $this->string : "[".$this->getTypeName()."]");
