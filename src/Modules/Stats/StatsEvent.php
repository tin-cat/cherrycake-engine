...
class StatsEvent extends \Cherrycake\Item {
	...
	protected $fields = [
		...
		"resolution" => ["type" => \Cherrycake\Modules\Database\Database::TYPE_INTEGER],
		"timestamp" => ["type" => \Cherrycake\Modules\Database\Database::TYPE_DATETIME],
		"secondary_id" => ["type" => \Cherrycake\Modules\Database\Database::TYPE_INTEGER],
		"tertiary_id" => ["type" => \Cherrycake\Modules\Database\Database::TYPE_INTEGER],
		"count" => ["type" => \Cherrycake\Modules\Database\Database::TYPE_INTEGER]
	];
	 ...
	 * @var timeResolution
	 */
	protected $timeResolution = \Cherrycake\Modules\Stats\StatsEvent::TIME_RESOLUTION_DAY;
	...
	function getTimestampForTimeResolution($timestamp = false) {
		...
		switch ($this->timeResolution) {
			case \Cherrycake\Modules\Stats\StatsEvent::TIME_RESOLUTION_MINUTE:
				$paramsSetup = [true, true, false, true, true, true];
				break;
			case \Cherrycake\Modules\Stats\StatsEvent::TIME_RESOLUTION_HOUR:
				$paramsSetup = [true, false, false, true, true, true];
				break;
			case \Cherrycake\Modules\Stats\StatsEvent::TIME_RESOLUTION_DAY:
				$paramsSetup = [false, false, false, true, true, true];
				break;
			case \Cherrycake\Modules\Stats\StatsEvent::TIME_RESOLUTION_MONTH:
				$paramsSetup = [false, false, false, true, false, true];
				break;
			case \Cherrycake\Modules\Stats\StatsEvent::TIME_RESOLUTION_YEAR:
