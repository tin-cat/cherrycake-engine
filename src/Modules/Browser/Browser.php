...
namespace Cherrycake\Modules\Browser;
...
class Browser extends \Cherrycake\Module {
	...
	const ENGINE_WEBKIT = 0;
	const ENGINE_GECKO = 1;
	const ENGINE_PRESTO = 2;
	const ENGINE_OTHERS = 3;

	var $engines = [
		self::BROWSER_CHROME => self::ENGINE_WEBKIT,
		self::BROWSER_SAFARI => self::ENGINE_WEBKIT,
		self::BROWSER_IPHONE => self::ENGINE_WEBKIT,
		self::BROWSER_IPAD => self::ENGINE_WEBKIT,
		self::BROWSER_IPOD => self::ENGINE_WEBKIT,
		self::BROWSER_ANDROID => self::ENGINE_WEBKIT,

		self::BROWSER_FIREFOX => self::ENGINE_GECKO,
		self::BROWSER_MOZILLA => self::ENGINE_GECKO,
		self::BROWSER_FIREBIRD => self::ENGINE_GECKO,

		self::BROWSER_OPERA => self::ENGINE_PRESTO,
		self::BROWSER_OPERA_MINI => self::ENGINE_PRESTO
	];
	 ...
	 * getEngine
	 *
	 * @return integer The engine used by the detected current browser
	 */
	function getEngine() {
	 ...
	 * getForEngine
	 *
	 * Accepts an array in the form of [ENGINE_WEBKIT => "Whatever for webkit browsers (i.e: Chrome, Safari)", ENGINE_GECKO => "Whatever for gecko browsers (i.e: Firefox)", ENGINE_PRESTO => "Whatever for presto browsers (i.e: Opera)", ENGINE_OTHERS => "Whatever for other browsers"], and returns the array element's value that matches the currently detected client browser
	 *
	 * @param array $data A hash array with the browser-engine dependant data
	...
	/**
	 * getMajorVersion
	 * @return string The major version of the browser
	 */
	public function getMajorVersion() {
		return strstr($this->getVersion(), ".", true);
	}
